...
const quiz = [
    {
        question: "Find the median where the following data represents the number of books read by 10 students during the summer: 5,8,12,15,7,10,6,9,13,11",
        ans: "Median = 9.5"
    },
    {
        question: `In a class of 30 students, 18 are boys and 12 are girls. One student is selected at random. What is the probability that the student selected is a girl?`,
        ans: "2/5 or 0.4",
    },
    {
