...
const quiz=[
    {
        question:`What was the name of first satellite launched by soviet union in
        1957 ?`,
        ans:"Spuntik 1"
    },
    {
        question:`When was the first asteroid names Ceres discovered ?`,
        ans:"1 Januray 1801",
    },
    {
        question: "WWhat is the first computer virus known as ?",
        ans: "Creeper Virus"
    },
    {
        question: `Which scientist wrote the book "Mathematical Principles of
        Natural Philosophy" ?`,
    ...
    {
        question: `How many quarks each do proton and neutron each consist ?`,
        ans: "3"
    },
    {
...
function science(){ 
    ...
    var procced=confirm("You are about to select the stream 'Science & Tech'");
    if(procced){
...
function pencil(){
    var procced=confirm("You are about to select the stream 'Sharpen Your Pencil'");
    if(procced){
        window.open("pencil.html", "_self");
    }
    else{
...
function history(){
    var procced=confirm("You are about to select the stream 'History & Politics'");
    if(procced){
...
function games(){
    var procced=confirm("You are about to select the stream 'Sports & Entertainment'");
    if(procced){
...
function pencil(){
    var procced=confirm("You are about to select the sream 'Sharpen Your Pencil'");
if (procced){
    window.open("pencil.html","_self");
}
else{
...
function audio(){
    var procced=confirm("Your are about to select the stream 'Audio & Visual'");
    if (procced){
